...
export default function StickySideNav() {
  ...
  const sections: NavSection[] = [
    { id: 'about-hero', label: 'About Company' },
    { id: 'our-story', label: 'Our Story' },
    { id: 'mission-vision', label: 'Mission & Vision' },
    { id: 'core-values', label: 'Core Values' },
    { id: 'our-journey', label: 'Our Journey' },
    { id: 'leadership', label: 'Leadership Director' },
    { id: 'our-team', label: 'Our Team' },
    { id: 'why-trust-us', label: 'Why Trust Us' },
    { id: 'achievements', label: 'Achievements' },
    { id: 'certifications', label: 'Certifications' },
    { id: 'awards-showcase', label: 'Awards' },
    { id: 'work-process', label: 'Work Process' },
    { id: 'client-testimonials', label: 'Testimonials' },
    { id: 'office-gallery', label: 'Office Ateliers' },
    { id: 'faq-section', label: 'FAQs Desk' }
  ];
